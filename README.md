...
- **fish (Friendly Interactive Shell)**  
  A smart and user-friendly shell with autosuggestions, syntax highlighting, and a modern scripting language. The script will make Fish the default shell.
